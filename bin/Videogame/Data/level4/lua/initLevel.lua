...
function init_level(a)
	...
	local cara1 = coreInstance:get_renderable_object_layer_manager():get_renderable_objects_manager_by_str_and_room("solid",0):get_resource("CARALLENGUA");
	cara1:blend_cycle(0, 1, 0);
	local cara2 = coreInstance:get_renderable_object_layer_manager():get_renderable_objects_manager_by_str_and_room("solid",0):get_resource("CARALLENGUA001");
