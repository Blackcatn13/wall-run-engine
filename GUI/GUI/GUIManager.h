...
class CGUIManager { //:public CScriptRegister
 ...
 public:
  ...
  void                SetChildVisibleGuiElement (const std::string &Element, const std::string &child, bool flag);
  ...
  void              SetRenderPrevWindows(bool flag) {m_drawPushedWindows = flag;}
  ...
  int								GetGUIHeartNumber();
  void							SetGUIHeartNumber(int input);
  ...
  void							SetIsCromoVisible(std::string _name, bool input);
  TransitionEffect				GetTransitionEffect() {
    return m_sTransitionEffect;
  }
 ...
 private:
  ...
  bool																m_isMainMenu;
  float																m_dt;
  bool                                m_drawPushedWindows;
  int                                 m_drawLastWindows;
};
