...
LPDIRECT3DVERTEXDECLARATION9 TCOLOR_TEXTURE2_NORMAL_VERTEX::s_VertexDeclaration=NULL;
LPDIRECT3DVERTEXDECLARATION9 & TCOLOR_TEXTURE2_NORMAL_VERTEX::GetVertexDeclaration()
{
	if(s_VertexDeclaration==NULL)
	{
		D3DVERTEXELEMENT9 l_VertexDeclaration[] =
