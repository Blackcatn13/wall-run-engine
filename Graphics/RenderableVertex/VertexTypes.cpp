...
LPDIRECT3DVERTEXDECLARATION9 TBILLBOARD_VERTEX::s_VertexDeclaration = NULL;
LPDIRECT3DVERTEXDECLARATION9 &TBILLBOARD_VERTEX::GetVertexDeclaration() {
  if (s_VertexDeclaration == NULL) {
    D3DVERTEXELEMENT9 l_VertexDeclaration[] = {
      {0, 0 , D3DDECLTYPE_FLOAT3, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_POSITION, 0},
      {0, 12, D3DDECLTYPE_FLOAT2, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_TEXCOORD, 0},
...
LPDIRECT3DVERTEXDECLARATION9 TBILLBOARD_INSTANCED_VERTEX::s_VertexDeclaration = NULL;
LPDIRECT3DVERTEXDECLARATION9 &TBILLBOARD_INSTANCED_VERTEX::GetVertexDeclaration() {
  if (s_VertexDeclaration == NULL) {
    D3DVERTEXELEMENT9 l_VertexDeclaration[] = {
      {0, 0 , D3DDECLTYPE_FLOAT3, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_POSITION, 0},
      {0, 12, D3DDECLTYPE_FLOAT2, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_TEXCOORD, 0},
