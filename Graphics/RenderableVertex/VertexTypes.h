...
// Defines of vertext types for switch
typedef enum VertexTypesEnum {
  VTTEXTURE_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_TEXTURE1,
  VTTEXTURE_POLY_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_TEXTURE1 | VERTEX_TYPE_POLY,
  VTTEXTURE_NORMAL_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_NORMAL | VERTEX_TYPE_TEXTURE1,
  VTTEXTURE_CUBE_NORMAL_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_NORMAL | VERTEX_TYPE_TEXTURE1 | VERTEX_TYPE_CUBE,
  VTTEXTURE_POLY_NORMAL_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_NORMAL | VERTEX_TYPE_TEXTURE1 | VERTEX_TYPE_POLY,
  VTCOLOR_TEXTURE_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_DIFFUSE | VERTEX_TYPE_TEXTURE1,
  VTCOLOR_TEXTURE_NORMAL_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_NORMAL | VERTEX_TYPE_DIFFUSE | VERTEX_TYPE_TEXTURE1,
  VTTEXTURE2_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_TEXTURE1 | VERTEX_TYPE_TEXTURE2,
  VTTEXTURE2_NORMAL_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_NORMAL | VERTEX_TYPE_TEXTURE1 | VERTEX_TYPE_TEXTURE2,
  VTCOLOR_TEXTURE2_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_DIFFUSE | VERTEX_TYPE_TEXTURE1 | VERTEX_TYPE_TEXTURE2,
  VTCOLOR_NORMAL_DIFFUSE_TEXTURE2_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_NORMAL | VERTEX_TYPE_DIFFUSE | VERTEX_TYPE_TEXTURE1 | VERTEX_TYPE_TEXTURE2,
  VTTEXTURE_NORMAL_TANGET_BINORMAL_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_NORMAL | VERTEX_TYPE_TANGENT | VERTEX_TYPE_BINORMAL | VERTEX_TYPE_TEXTURE1,
  VTTEXTURE2_NORMAL_TANGET_BINORMAL_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_NORMAL | VERTEX_TYPE_TANGENT | VERTEX_TYPE_BINORMAL | VERTEX_TYPE_TEXTURE1 | VERTEX_TYPE_TEXTURE2,
  VTTEXTURE2_RNORMALM_TANGET_BINORMAL_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_NORMAL | VERTEX_TYPE_TANGENT | VERTEX_TYPE_BINORMAL | VERTEX_TYPE_TEXTURE1 | VERTEX_TYPE_TEXTURE2 | VERTEX_TYPE_RNM,
  VTCOLORED_TEXTURE_NORMAL_TANGET_BINORMAL_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_NORMAL | VERTEX_TYPE_TANGENT | VERTEX_TYPE_BINORMAL | VERTEX_TYPE_DIFFUSE | VERTEX_TYPE_TEXTURE1,
  VTCOLORED_TEXTURE2_NORMAL_TANGET_BINORMAL_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_NORMAL | VERTEX_TYPE_TANGENT | VERTEX_TYPE_BINORMAL | VERTEX_TYPE_DIFFUSE | VERTEX_TYPE_TEXTURE1 | VERTEX_TYPE_TEXTURE2,
  VTCOLORED_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_DIFFUSE,
  VTCOLORED_NORMAL_VERTEX = VERTEX_TYPE_GEOMETRY | VERTEX_TYPE_NORMAL | VERTEX_TYPE_DIFFUSE
};
