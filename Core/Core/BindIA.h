...
void RegisterAI() {
  ...
  luabind::module(LUA_STATE) [
    ...
    .property("m_Hide", &CEasyEnemy::getHide, &CEasyEnemy::setHide)
    .property("m_OffsetHide", &CEasyEnemy::getOffsetHide, &CEasyEnemy::setOffsetHide)
    .property("m_Hiding", &CEasyEnemy::getHiding, &CEasyEnemy:: setHiding)
