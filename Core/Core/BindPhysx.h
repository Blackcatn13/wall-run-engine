...
void RegisterPhysX() {
  ...
  luabind::module(LUA_STATE) [
    ...
    .def("rotate_by_angles", &CPhysicActor::RotateByAngles)
  ];
  luabind::module(LUA_STATE) [
    ...
    .def("set_step", &CPhysicController::SetStepOffset)
  ...
  luabind::module(LUA_STATE) [
    ...
    .property("m_isTurned", &CPlayerController::getisTurned, &CPlayerController::setisTurned)
    ...
    .property("m_JumpingTime", &CPlayerController::getJumpingTime, &CPlayerController::setJumpingTime)
    ...
    .property("m_Room", &CPlayerController::getRoom, &CPlayerController::setRoom)
