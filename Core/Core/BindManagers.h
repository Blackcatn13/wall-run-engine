...
void RegisterManagers() {
  ...
  luabind::module(LUA_STATE) [
    ...
    .def("get_game_pad_left_thumb_y_deflection", &CInputManager::GetGamePadLeftThumbYDeflection)
    .def("get_game_pad_left_thumb_x_deflection", &CInputManager::GetGamePadLeftThumbXDeflection)
  ];
  luabind::module(LUA_STATE) [
  ...
  luabind::module(LUA_STATE) [
    ...
    .def(constructor<>())
    .def_readwrite("m_bDoEffect", &TransitionEffect::m_bDoEffect)
    .def_readwrite("m_fTransitionTime", &TransitionEffect::m_fTransitionTime)
    .def_readwrite("m_currentState", &TransitionEffect::m_fTimeCounter)
    .def_readwrite("m_sWindowsName", &TransitionEffect::m_sWindowsName)
    .def_readwrite("m_bActiveWindows", &TransitionEffect::m_bActiveWindows)
  ];
  luabind::module(LUA_STATE) [
    ...
    .def("get_is_paused", &CGUIManager::GetIsPaused)
    .def("set_is_paused", &CGUIManager::SetIsPaused)
    .def("activate_pause", &CGUIManager::ActivatePause)
    ...
    .def("get_num_heart", &CGUIManager::GetGUIHeartNumber)
    .def("set_num_heart", &CGUIManager::SetGUIHeartNumber)
    ...
    .def("get_is_mainmenu", &CGUIManager::GetIsMainMenu)
    .def("set_is_mainmenu", &CGUIManager::SetIsMainMenu)
    ...
    .def("set_visible_gui_child_element", &CGUIManager::SetChildVisibleGuiElement)
    .def("get_visible_gui_element", &CGUIManager::GetVisibleGuiElement)
    .def("set_visible_element", &CGUIManager::SetIsCromoVisible)
