...
class CPhysicsManager {
 public:
  ...
  CPhysicController					*CreateSphericalPhisicController			(float _fRadius, float _fHeight, float _fSlope, float _fSkinwidth, float _fStepOffset
  ...
  void					SetPaintAllPhysicControllers	(bool paint);
