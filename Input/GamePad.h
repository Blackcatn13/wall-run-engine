...
struct PAD_CONTROLLER {
  ...
  WORD                m_wNewButtons;
  Vect2i							m_Pos;
  Vect2i              m_LastDeltaTriggers;
  Vect2i              m_CurrentDeltaTriggers;
};
...
class CGamePad {
 public:
  ...
  bool            GetTriggerIsDown          (uint32 nTrigger, uint32 idController = 0);
  bool            GetTriggerIsDownUp        (uint32 nTrigger, uint32 idController = 0);
  bool            GetTriggerIsUpDown        (uint32 nTrigger, uint32 idController = 0);
